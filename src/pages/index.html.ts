...
export const description =
  "Learn Starknet Privacy (STRK20) with simple, runnable examples — private transfers on a public chain, Cairo anonymizer contracts, and wallet-builder SDK flows."
